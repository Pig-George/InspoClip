...
import { buildIdeaDays, promptText, searchWorkspaceAssets, workspaceTitle, type WorkspaceAsset } from "../../../packages/inspoclip-workspace-ui/src/model"
...
describe("shared workspace UI model", () => {
